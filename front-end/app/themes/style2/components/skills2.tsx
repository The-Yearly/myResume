  ...
  return (
    <section id="skills" className="py-24 md:py-32 bg-slate-50 w-full">
      <div className="container px-6 mx-auto">
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 ${props.skills.length === 1 ? "lg:grid-cols-1" : props.skills.length === 2 ? "lg:grid-cols-2" : "lg:grid-cols-3"} gap-8`}
        >
          {props.skills.map((skill, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="px-3 py-2 flex justify-center items-center bg-indigo-50 rounded-full mb-2">
                  {renderIcon(skill.icon as string)}
                </div>
