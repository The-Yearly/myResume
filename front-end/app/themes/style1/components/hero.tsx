      ...
      <div className="px-4 md:px-6">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            <h1
              className={`text-3xl  font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-${color.Hero}`}
            >
              {props.content.hero}
            </h1>
            <p
              className={`mx-auto max-w-[700px] md:text-xl text-${color.Sub_Hero}`}
            >
          ...
          <div className="space-x-4">
            <button
              className={`bg-${color.Button_1} p-3 rounded-lg text-md text-${color.Button_1_Text}`}
              onClick={() =>
                document
