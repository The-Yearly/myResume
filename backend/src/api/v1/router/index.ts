  ...
  if (sessions?.sessions.includes(session || "abc")) {
    ...
    const response = await client.experience.update({
      ...
      data: {
        ...
        startdate: parsedResponse.data.startdate,
        enddate:
          parsedResponse.data.enddate != null
            ? parsedResponse.data.enddate
            : null,
      },
    });
    console.log(response);
  ...
  try {
    ...
    await client.project.create({
      data: {
        ...
        github: "#",
        image:
          "https://imgs.search.brave.com/qFUuEh8DOR-oN8lV8Ju89PCx2JaKiE8l55FZ0tvWVjc/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9yZXBv/c2l0b3J5LWltYWdl/cy5naXRodWJ1c2Vy/Y29udGVudC5jb20v/ODI0NTI1MTk1L2Ez/OWFkMjk5LTg3M2Yt/NDY0Zi1iOWMwLTk2/OTllNGFlMWE4ZA",
        Link: "#",
        tags: ["Flutter"],
      },
    });
